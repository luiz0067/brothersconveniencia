...
<?php
	...
	?>
	<div class="letra30MyriadPro" style="margin-left:10px; padding-top:10px; color:#7F682c;margin-bottom:30px;">
	<?php echo $imagem_titulo;?>
	</div>
	
	<div class="produto_grande">
		<div class="imagem_produto_grande">
			<img src="./uploads/fotos/g_<?php echo $imagem_imagem;?>" alt="brothers"  
