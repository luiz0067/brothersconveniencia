...
<div class="conteudo">
		...
		<a href="./uploads/fotos/g_<?php echo $row ['imagem'];?>" rel="lightbox[roadtrip]">
				<img src="./uploads/fotos/g_<?php echo $row ['imagem'];?>" alt="brothers" title="brothers" name="brothers" border="0" style="margin-top:10px;margin-left:10px;" width="187" height="137"  />
			</a>
